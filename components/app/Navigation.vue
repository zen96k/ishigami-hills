<template>
  <div>
    <nav class="fixed top-0 z-50 w-full bg-red-950">
        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center justify-start">
            <button
              ...
              class="inline-flex items-center rounded-lg p-2 lg:hidden"
            >
              <Icon
            ...
            >
              ...
              <div class="flex flex-col items-center">
                <span
                  class="self-center text-xl font-semibold text-white lg:text-2xl"
                >
                  石上ヒルズ
                </span>
                <span class="text-xs text-white lg:text-sm"
                  >アジカンの非公式ファンサイト。</span
                >
              </div>
            </NuxtLink>
    ...
    <aside
      id="logo-sidebar"
      class="fixed left-0 top-0 z-40 h-screen w-64 -translate-x-full border-r border-gray-200 bg-white pt-20 transition-transform dark:border-gray-700 dark:bg-gray-800 lg:translate-x-0"
      aria-label="Sidebar"
    >
